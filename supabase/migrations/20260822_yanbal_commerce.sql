-- Bootstrap the original storefront schema when installing into a new project.
-- Existing projects are left intact; the later ALTER statements only add fields.
